...
const names = {
  ...
  [SkillSetType.SorceressLightningMastery]:
    'Lightning Mastery (Sorceress Only)',
  [SkillSetType.SorceressFireMastery]: 'Fire Mastery (Sorceress Only)',
  [SkillSetType.SorceressColdMastery]: 'Cold Mastery (Sorceress Only)',
